...
Object.keys(grass).forEach(key => grass[key].swap());

export const smallBuildings = {
    'BA-R': new Vector2(0, 0), 'ST-L': new Vector2(0, 1),
    'CA-L': new Vector2(1, 0), 'SH-R': new Vector2(1, 1),
    'SL-L': new Vector2(2, 0), 'ST-R': new Vector2(2, 1),
}
Object.keys(smallBuildings).forEach(key => smallBuildings[key].swap());
